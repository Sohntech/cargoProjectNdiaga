...
<div class="flex">
    ...
    <div class="mt-6">
        ...
        <select id="cargo-type-search" class="bg-gray-50 border border-gray-300 text-gray-900  rounded-lg focus:ring-blue-500 block w-fit py-3 pl-2 pr-11 ml-3 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500">
...
<div class="overflow-x-auto mt-5">
    <table class="table">
        ...
        <tbody class="bg-[#2596be] text-white font-extrabold" id="tbody-cargo">
        ...
        <input type="hidden" name="totalAmount" value="0">
          ...
          <div class="mt-5 flex flex-row gap-2">
            <div class="flex items-center gap-2">
                <input type="radio" name="radio-2" id="byWeight" class="radio radio-success" checked /><label for="">Remplissage par poids</label>
            </div>
            <div class="flex items-center gap-2">
                <input type="radio" name="radio-2" id="byProduct" class="radio radio-success"/>Remplissage par nombre de produit/colis
            </div>
          </div>
